...
class InstallationController {
    ...
    autoPlayLoop = () => {
        ...
        // 4. On appelle manuellement la boucle de rendu principale (animateLoop) 
        // pour dessiner la frame et éviter d'avoir deux boucles requestAnimationFrame concurrentes.
        if (typeof animateLoop === 'function') {
            animateLoop(now);
        }
    }
}
